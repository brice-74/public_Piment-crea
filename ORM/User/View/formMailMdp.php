...
if(isset($result)): ?>
	<div class="main-container-max">
		...
		echo "href=\"".DOMAINE.$attero."\""
		?> 
		class="retour2 cGris bold Iflex pl0">
	...
	<div class="maxW600"><h1 class="titre2 mb60 alignCenter">Mail d'activation nouveau mot de passe</h1></div>
