...
$page->setPage("favoris");
if(isset($result)): ?>
	<div class="main-container-min m-10">
		<p class="borderB pb5 cGris posR ml10 mr10">Derniers visuels ajoutés aux favoris<span id="toggleChaine"></span></p>
		<div class="flex flex1 flex-wrap mb40" id="slideChaine">
					 	...
					 	<div class="container-bloc p10 dpIB">
						 	<div class="container-visuels">
							 	<a class="p0" href="<?php echo DOMAINE ?>visuel-<?php echo $visuel->getIdVisuel(); ?>-<?php echo preg_replace("/.jpg$|.jpeg$|.png$/", '', $visuel->getVisuelVisuel()) ?>"
							 		<?php echo "style=\"background-image:url(".DOMAINE."medias/chaine/id-".$visuel->id_chaine."/visuel/".$visuel->getVisuelVisuel().")\""?> 
							 	>
									<img class="img-visuel" src="
									<?php echo DOMAINE?>medias/chaine/id-<?php echo $visuel->id_chaine ?>/visuel/<?php echo $visuel->getVisuelVisuel() ?>"
									>
								</a>
							</div>
							<div class="flex pb5 pt5">
									<a href="chaine-<?php echo $visuel->id_chaine ?>/visuels" class="p0 container-avatar-min posR t0 l0"
								...
								<div class="mAuto0 ml10">
									...
									<p class="txt12 cGris mb0"><?php echo $transformDate->transformDateTime($visuel->date_favoris); ?></p>
								</div>
		...
		<p class="borderB pb5 cGris posR ml10 mr10">Derniers tutos ajoutés aux favoris<span id="toggleTuto"></span></p>
		<div class="flex flex1 flex-wrap" id="slideTuto">
					 	...
					 	<div class="container-bloc p10 dpIB">
						 	<div class="container-visuels posR">
							 	<a class="p0" href="<?php echo DOMAINE ?>tuto-<?php echo $tuto->getIdTuto(); ?>-<?php echo $tuto->getTitreTuto(); ?>"
							 		<?php echo "style=\"background-image:url(".DOMAINE."medias/chaine/id-".$tuto->id_chaine."/tuto-".$tuto->getIdTuto()."/".$tuto->getVisuelTuto().")\""?> 
							 	>
									<img class="img-visuel" src="
									<?php echo DOMAINE?>medias/chaine/id-<?php echo $tuto->id_chaine ?>/tuto-<?php echo $tuto->getIdTuto() ?>/<?php echo $tuto->getVisuelTuto() ?>"
									>
								</a>
							...
							<div class="flex pb5 pt5">
									<a href="chaine-<?php echo $tuto->id_chaine ?>/tutos" class="p0 container-avatar-min posR t0 l0"
								...
								<div class="mAuto0 ml10 cutBox1">
									...
									<p class="txt12 cGris mb0"><?php echo $transformDate->transformDateTime($tuto->date_favoris); ?></p>
								</div>
								<div class="mt5 mlAuto">
								...
								<div class="posR">
									...
									<div class="optionPost">
										...
										<button class="sig flex" modale="btn-signal" title="signaler un abus" datas="visuel-<?php echo $tuto->getIdTuto(); ?>">
											<svg class="ml5" version="1.1" viewBox="0 0 25 25" xml:space="preserve">
												<g>
													<g>
														<path class="st0" d="M7,23c-0.7,0-1.3-0.6-1.3-1.3V3.9c0-0.7,0.6-1.3,1.3-1.3s1.3,0.6,1.3,1.3v17.8C8.3,22.4,7.7,23,7,23z"/>
