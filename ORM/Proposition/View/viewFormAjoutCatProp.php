...
if(isset($result)): ?>
	...
	<div class="maxW600"><h1 class="titre2 mb60 alignCenter">Ajout d'une catégorie proposé</h1></div>
...
<script src="<?php echo DOMAINE; ?>templates/front/js/selectNoMulti.js"></script>